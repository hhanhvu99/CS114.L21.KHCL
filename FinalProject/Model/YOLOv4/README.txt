...
mask_yolo_train: chứa ảnh train và file nhãn theo format YOLO
...
train.txt: chứa absolute path tới từng ảnh trong folder mask_yolo_train 
test.txt: chứa absolute path tới từng ảnh trong folder mask_yolo_test

Các mục trong FinalProject, lưu ý có vài thư mục content bị bỏ trống, để xem đầy đủ xin vào Drive của nhóm:
AnhColab: Chứa các ảnh sẽ dùng trong Colab Notebook
Data: Chứa toàn bộ data trong project
Model: Chứa toàn bộ model trong project
